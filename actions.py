...
class Actions:
    ...
    def challenge(self, playercounter, playerdoubt, player_list, playern, name):
        ...
        def action(action, playercounter, playerdoubt, playern, name):
            ...
            if name == "foreingn_aid":
                ...
                if action == "challenge_none":
                    ...
                    if name in playercounter.cards:
                        ...
                        #Cards.return_card(player_list[playern], index)
            ...
            #----------------------------------------------------------
                ...
                if action == "challenge_none":
                    ...
                    if name in player_list[playern].cards:
                        #index = player_list[playern].cards.index(name)
                        #ards.return_card(player_list[playern], index)
                        print(playerdoubt.cards)
                        self.remove(player, player_list, playern, name)
                    else:
                        self.remove(player_list[playern], player_list, playern, name)
        ...
        challenge_1 = tki.Button(challenge_panel, text="Player 1", font="consolas 20", command = lambda: action("challenge_p1", playercounter, player_list[0], playern, name))
        challenge_1.pack()
        challenge_2 = tki.Button(challenge_panel, text="Player 2", font="consolas 20", command = lambda: action("challenge_p2", playercounter, player_list[1], playern, name))
        challenge_2.pack()
        challenge_3 = tki.Button(challenge_panel, text="Player 3", font="consolas 20", command = lambda: action("challenge_p3", playercounter, player_list[2], playern, name))
        challenge_3.pack()

        if len(player_list) == 4:
            challenge_4 = tki.Button(challenge_panel, text="Player 4", font="consolas 20", command = lambda: action("challenge_p4", playercounter, player_list[3], playern, player_list))
            challenge_4.pack()

        challenge_none = tki.Button(challenge_panel, text =" Pass ", font="consolas 20", command = lambda: action("challenge_none", playercounter, player_list[0], playern, player_list))
        challenge_none.pack()
        ...
        def action(action, target, playern, player_list, name):
            ...
            if playern == target:
                ...
                if action == "ca_p1":
                    ...
                    self.challenge(player_list[0], player_list[0], player_list, playern, name)
                elif action == "ca_p2":
                    print(player_list[1].name_id, "DO COUNTERACTION TO ", player.name_id)

                    self.challenge(player_list[1], player_list[0],player_list, playern, name)
                elif action == "ca_p3":
                    print(player_list[2].name_id, "DO COUNTERACTION TO ", player.name_id)
                    
                    self.challenge(player_list[2], player_list[0],player_list, playern, name)
                elif action == "ca_p4":
                    print("Player 4 DO COUNTERACTION TO ", player.name_id)

                    print(player_list[3].name_id, "DO COUNTERACTION TO ", player.name_id)
                    self.challenge(player_list[3], player_list[0],player_list, playern, name)
                elif action == "ca_none":
                    if name == "foreingn_aid":
                        print("PASS")
                        player_list[playern].coins += 2
    ...
    def tax(self, player_list, playern):
        screen_update = Screen_update(player_list)
        self.challenge(player_list[playern], player_list[playern], player_list, playern,"duke")
    ...
    def assassinate(self,player, player_list, playern, name): #Añadir deabte de debate 
